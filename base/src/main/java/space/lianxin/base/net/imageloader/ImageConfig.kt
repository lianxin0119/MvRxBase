...
/**
 * ImageConfig.
 * Create by YangYang on 2018/10/11 16:39.
 */
class ImageConfig constructor(builder: Builder? = null) {
    ...
    init {
        builder?.let { build ->
            ...
            failedCallBack = build.failedCallBack
            requestSuccessCallBack = build.requestSuccessCallBack
        }
    }
    ...
    class Builder {
        ...
        fun onFailedCallBack(callBack: ((GlideException) -> Unit)): Builder {
            failedCallBack = callBack
            return this
        }

        fun onRequestSuccessCallBack(callBack: (Bitmap?) -> Unit): Builder {
